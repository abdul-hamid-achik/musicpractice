...
export default defineEventHandler(async (event) => {
  try {
    ...
    if (
      body.targetMinutesPerWeek !== undefined &&
      (!Number.isInteger(body.targetMinutesPerWeek) || body.targetMinutesPerWeek < 1)
    ) {
    ...
    if (body.targetMinutesPerWeek !== undefined)
      updates.targetMinutesPerWeek = body.targetMinutesPerWeek;
