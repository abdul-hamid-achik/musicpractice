...
async function seed() {
  ...
  const [demoUser] = await db
    .select()
    .from(users)
    .where(eq(users.email, 'demo@musicpractice.app'))
    .limit(1);

  // Seed instruments
  const [guitar, bass, piano, violin] = await db
    .insert(instruments)
    .values([
      {
  ...
  console.log(
    'Instruments seeded:',
    [guitar, bass, piano, violin].map((i) => i.name),
  );
  ...
  await db.insert(scales).values([
    {
      ...
      category: 'diatonic',
      description: 'The major scale, foundation of Western music',
    },
    {
    ...
    },
    {
      ...
      intervals: [0, 2, 4, 7, 9],
      category: 'pentatonic',
      description: 'Five-note major scale, widely used in rock and blues',
    },
    {
      name: 'Pentatonic Minor',
      intervals: [0, 3, 5, 7, 10],
      category: 'pentatonic',
      description: 'Five-note minor scale, essential for blues and rock soloing',
    },
    {
      name: 'Blues',
    ...
    },
    {
      ...
      category: 'diatonic',
      description: 'Second mode of the major scale, minor with raised 6th',
    },
    {
      name: 'Phrygian',
      intervals: [0, 1, 3, 5, 7, 8, 10],
      category: 'diatonic',
      description: 'Third mode, minor with flat 2nd, Spanish flavor',
    },
    {
      name: 'Lydian',
      intervals: [0, 2, 4, 6, 7, 9, 11],
      category: 'diatonic',
      description: 'Fourth mode, major with raised 4th',
    },
    {
      name: 'Mixolydian',
      intervals: [0, 2, 4, 5, 7, 9, 10],
      category: 'diatonic',
      description: 'Fifth mode, major with flat 7th, dominant sound',
    },
    {
      name: 'Aeolian',
      intervals: [0, 2, 3, 5, 7, 8, 10],
      category: 'diatonic',
      description: 'Sixth mode, identical to natural minor',
    },
    {
      name: 'Locrian',
      intervals: [0, 1, 3, 5, 6, 8, 10],
      category: 'diatonic',
      description: 'Seventh mode, diminished sound with flat 2nd and flat 5th',
    },
    {
      name: 'Whole Tone',
      intervals: [0, 2, 4, 6, 8, 10],
      category: 'symmetric',
      description: 'Symmetrical scale with only whole steps',
    },
    {
      name: 'Diminished Half-Whole',
      intervals: [0, 1, 3, 4, 6, 7, 9, 10],
      category: 'symmetric',
      description: 'Alternating half and whole steps, starting with half',
    },
    {
      name: 'Diminished Whole-Half',
      intervals: [0, 2, 3, 5, 6, 8, 9, 11],
      category: 'symmetric',
      description: 'Alternating whole and half steps, starting with whole',
    },
    {
      name: 'Chromatic',
    ...
    },
    {
      ...
      category: 'exotic',
      description: 'Harmonic minor with raised 4th, Eastern European sound',
    },
    {
      name: 'Double Harmonic',
      intervals: [0, 1, 4, 5, 7, 8, 11],
      category: 'exotic',
      description: 'Also called Byzantine scale, Middle Eastern flavor',
    },
    {
      name: 'Phrygian Dominant',
      intervals: [0, 1, 4, 5, 7, 8, 10],
      category: 'exotic',
      description: 'Fifth mode of harmonic minor, flamenco sound',
    },
    {
      name: 'Lydian Dominant',
      intervals: [0, 2, 4, 6, 7, 9, 10],
      category: 'jazz',
      description: 'Lydian with flat 7th, used over dominant 7th chords',
    },
    {
      name: 'Altered',
    ...
    },
    {
      ...
      intervals: [0, 1, 3, 4, 6, 8, 10],
      category: 'jazz',
      description: 'Also known as altered scale, all tensions altered',
    },
    {
      name: 'Bebop Dominant',
      intervals: [0, 2, 4, 5, 7, 9, 10, 11],
      category: 'jazz',
      description: 'Mixolydian with added major 7th for chromatic passing',
    },
    {
      name: 'Bebop Major',
      intervals: [0, 2, 4, 5, 7, 8, 9, 11],
      category: 'jazz',
      description: 'Major scale with added flat 6th',
    },
    {
      name: 'Bebop Dorian',
      intervals: [0, 2, 3, 4, 5, 7, 9, 10],
      category: 'jazz',
      description: 'Dorian with added major 3rd',
    },
    {
      name: 'Hirajoshi',
      intervals: [0, 4, 6, 7, 11],
      category: 'exotic',
      description: 'Japanese five-note scale',
    },
    {
      name: 'In Sen',
    ...
    },
    {
      ...
      category: 'exotic',
      description: 'Harmonic minor with flat 2nd',
    },
    {
      name: 'Neapolitan Major',
      intervals: [0, 1, 3, 5, 7, 9, 11],
      category: 'exotic',
      description: 'Major scale with flat 2nd',
    },
    {
      name: 'Major Blues',
      intervals: [0, 2, 3, 4, 7, 9],
      category: 'blues',
      description: 'Major pentatonic with added flat 3rd',
    },
    {
      name: 'Minor Blues',
      intervals: [0, 3, 5, 6, 7, 10],
      category: 'blues',
      description: 'Minor pentatonic with added flat 5th (same as Blues scale)',
    },
    {
      name: 'Prometheus',
      intervals: [0, 2, 4, 6, 9, 10],
      category: 'exotic',
      description: 'Whole tone scale variant by Scriabin',
    },
    {
      name: 'Tritone',
      intervals: [0, 1, 4, 6, 7, 10],
      category: 'exotic',
      description: 'Symmetric scale built on tritone intervals',
    },
    {
      name: 'Augmented',
      intervals: [0, 3, 4, 7, 8, 11],
      category: 'symmetric',
      description: 'Symmetrical scale alternating minor 3rd and half step',
    },
    {
      name: 'Enigmatic',
      intervals: [0, 1, 4, 6, 8, 10, 11],
      category: 'exotic',
      description: 'Mysterious scale by Verdi',
    },
  ]);
