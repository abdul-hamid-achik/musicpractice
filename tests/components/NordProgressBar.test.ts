...
import NordProgressBar from '~/components/ui/NordProgressBar.vue';
...
describe('NordProgressBar', () => {
  it('renders a bar with width set to the value', () => {
    const wrapper = mount(NordProgressBar, { props: { value: 42 } });
