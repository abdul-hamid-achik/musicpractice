  ...
  <div>
    ...
    <div class="flex items-center justify-between mb-2">
      ...
      <NuxtLink to="/practice/session?instrument=guitar">
        <UiButton variant="primary" size="sm">Practice Guitar</UiButton>
      </NuxtLink>
    </div>
    <p class="text-text-muted mb-6">
      Interactive 6-string fretboard — visualize scales, chords, and fingering patterns.
    </p>
    ...
    <template v-else>
          ...
          >
            <template v-for="(tunings, category) in tuningsByCategory" :key="category">
              <optgroup :label="categoryLabels[category] || category">
                <option v-for="t in tunings" :key="t.name" :value="GUITAR_TUNINGS.indexOf(t)">
      ...
      <!-- Note Display -->
      <UiCard v-if="lastClickedNote" title="Last Played">
